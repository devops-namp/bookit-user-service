...
INSERT INTO public."bookit-users" (username, password, email, role, firstname, lastname, city)
...
INSERT INTO public."bookit-users" (username, password, email, role, firstname, lastname, city)
VALUES ('username3', 'y4t6TyLTziBF7p9CT75tfqTGmMiNMAs5dyzMZKL2e9g=', 'name3@example.com', 'HOST', 'Ime2', 'Prezime2', 'Beograd');